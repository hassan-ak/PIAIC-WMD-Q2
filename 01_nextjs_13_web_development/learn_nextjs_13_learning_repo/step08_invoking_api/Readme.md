# Everything Must and Will be Transformed into an Application Programming Interface (API)

- [API Economy Presentation](https://docs.google.com/presentation/d/1rjiNSoQV87mgZNCCA5xf__B-OOTTuK7CCriwpesDR90/edit?usp=sharing)


## Support Reading Material For API Economy:
